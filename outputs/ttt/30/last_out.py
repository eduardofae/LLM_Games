...
def jdv():
  ...
  print("Game Rules:")
  print("- Players take turns placing their pieces (X or O) on the grid.")
  print("- The first player to get three of their pieces in a row (horizontally, vertically, or diagonally) wins.")
  print("- If all the spaces on the grid are filled without a winner, the game is a draw.")

  # Play the game
  while True:
    # Display the grid
    grid_table = prettytable.PrettyTable()
    grid_table.field_names = ["1", "2", "3"]
    for row in grid:
